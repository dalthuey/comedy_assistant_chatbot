    ...
    def get_response(self, prompt: str, temperature: float = 0.7, max_tokens: int = 300) -> str:
        ...
        try:
            response = openai.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": '''You are a professional comedian and humor expert.
                                                    You excel at creating jokes and punchlines based on specific premises.
                                                    Always ensure the humor is creative, contextually relevant,
                                                    and aligns closely with the user's input.'''
                                                    },
